...
(function () {
  ...
  */
  ...
  // ../commerce.js/src/polyfills.coffee
  ...
  // ../commerce.js/src/analytics.coffee
  var analytics;
  ...
  let requestAnimationFrame$2 = root.requestAnimationFrame || ((fn) => root.setTimeout(fn, 50 / 3));
  ...
  // node_modules/es6-tween/src/PlaybackPosition.js

  // node_modules/es6-tween/src/Timeline.js
  ...
  */
  ...
  // node_modules/shop.js/templates/containers/checkout-card.pug
  var html$8 = "\n<form onsubmit=\"{ submit }\">\n  <yield>\n    <div class=\"contact checkout-section\">\n      <h2>Contact</h2>\n      <div class=\"fields\">\n        <user-name class=\"input\" label=\"Name\"></user-name>\n        <user-email class=\"input\" label=\"Email\"></user-email>\n      </div>\n    </div>\n    <div class=\"payment checkout-section\">\n      <h2>Payment</h2><span class=\"secured-text\">SSL Secure<span>Checkout</span><img class=\"lock-icon\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/lock-icon.svg\"></span>\n      <div class=\"fields\">\n        <card-name class=\"input\" label=\"Name on Card\"></card-name>\n        <card-number class=\"input\" name=\"number\" label=\"Card Number\">\n          <div class=\"cards-accepted\"><img class=\"card-logo amex-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/card-logos/amex.svg\"><img class=\"card-logo visa-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/card-logos/visa.svg\"><img class=\"card-logo discover-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/card-logos/discover.svg\"><img class=\"card-logo jcb-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/card-logos/jcb.svg\"><img class=\"card-logo mastercard-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/card-logos/mastercard.svg\"><a class=\"stripe-link\" href=\"//www.stripe.com\" target=\"_blank\"><img class=\"stripe-logo\" src=\"//cdn.jsdelivr.net/gh/hanzo-io/shop.js/img/stripelogo.png\"></a></div>\n        </card-number>\n        <card-expiry class=\"input\" name=\"expiry\" label=\"MM / YY\"></card-expiry>\n        <card-cvc class=\"input\" name=\"cvc\" label=\"CVC\"></card-cvc>\n      </div>\n    </div>\n    <button class=\"checkout-next\" type=\"submit\">Continue &#10140;</button>\n    <div class=\"error\" if=\"{ errorMessage }\">{ errorMessage }</div>\n  </yield>\n</form>";

  // node_modules/shop.js/src/containers/checkout-card.coffee
  ...
  // node_modules/shop.js/templates/containers/checkout-shippingaddress.pug
  ...
  // node_modules/shop.js/src/containers/checkout-shippingaddress.coffee
  ...
  // node_modules/shop.js/templates/containers/cart.pug
  ...
  // node_modules/shop.js/src/containers/cart.coffee
  var CartForm,
    extend$J = function(child, parent) { for (var key in parent) { if (hasProp$I.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$I = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/templates/containers/lineitem.pug
  ...
  // node_modules/shop.js/src/containers/lineitem.coffee
  var LineItemForm,
    extend$L = function(child, parent) { for (var key in parent) { if (hasProp$K.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$K = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/templates/containers/lineitems.pug
  ...
  // node_modules/shop.js/src/containers/lineitems.coffee
  var LineItems,
    extend$M = function(child, parent) { for (var key in parent) { if (hasProp$L.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$L = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/templates/containers/order.pug
  ...
  // node_modules/shop.js/src/containers/order.coffee
  var OrderForm,
    extend$O = function(child, parent) { for (var key in parent) { if (hasProp$N.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$N = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/templates/containers/orders.pug
  ...
  // node_modules/shop.js/src/containers/orders.coffee
  var Orders,
    extend$P = function(child, parent) { for (var key in parent) { if (hasProp$O.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$O = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/src/containers/shippingaddress.coffee
  ...
  // node_modules/shop.js/src/containers/index.coffee
  var Forms;
  ...
  // node_modules/shop.js/templates/widgets/checkout-modal.pug
  ...
  // node_modules/shop.js/src/mediator.coffee

  var m$1 = observable({});

  // node_modules/shop.js/src/widgets/checkout-modal.coffee
  var CheckoutModal,
    extend$Z = function(child, parent) { for (var key in parent) { if (hasProp$Y.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$Y = {}.hasOwnProperty;
  ...
  // node_modules/shop.js/templates/widgets/side-pane.pug
  var html$p = "\n<div class=\"side-pane { opened: opened, closed: !opened }\">\n  <div class=\"side-pane-close\" onclick=\"{ close }\">&#10140;</div>\n  <div class=\"side-pane-content\">\n    <yield></yield>\n  </div>\n</div>";

  // node_modules/shop.js/src/widgets/side-pane.coffee
  var SidePane,
    extend$_ = function(child, parent) { for (var key in parent) { if (hasProp$Z.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp$Z = {}.hasOwnProperty;

  SidePane = (function(superClass) {
    extend$_(SidePane, superClass);
  ...
  // node_modules/shop.js/src/widgets/index.coffee
  var Widgets;
  ...
  function createInvalid (flags) {
      var m = createUTC(NaN);
      if (flags != null) {
          extend$10(getParsingFlags(m), flags);
      }
      else {
  ...
  function mergeConfigs(parentConfig, childConfig) {
      var res = extend$10({}, parentConfig), prop;
      for (prop in childConfig) {
          if (hasOwnProp(childConfig, prop)) {
              if (isObject$3(parentConfig[prop]) && isObject$3(childConfig[prop])) {
                  res[prop] = {};
                  extend$10(res[prop], parentConfig[prop]);
                  extend$10(res[prop], childConfig[prop]);
  ...
  function localeWeekdays (m, format) {
      var weekdays = isArray$3(this._weekdays) ? this._weekdays :
  ...
  function configFromStringAndArray(config) {
      ...
      extend$10(config, bestMoment || tempConfig);
  }
  ...
  function mod$2(dividend, divisor) {
  ...
  function startOf (units) {
      ...
      switch (units) {
          ...
          case 'hour':
              ...
              time -= mod$2(time + (this._isUTC ? 0 : this.utcOffset() * MS_PER_MINUTE), MS_PER_HOUR);
              break;
          case 'minute':
              time = this._d.valueOf();
              time -= mod$2(time, MS_PER_MINUTE);
              break;
          case 'second':
              time = this._d.valueOf();
              time -= mod$2(time, MS_PER_SECOND);
              break;
      }
  ...
  function endOf (units) {
      ...
      switch (units) {
          ...
          case 'hour':
              time = this._d.valueOf();
              time += MS_PER_HOUR - mod$2(time + (this._isUTC ? 0 : this.utcOffset() * MS_PER_MINUTE), MS_PER_HOUR) - 1;
              break;
          case 'minute':
              time = this._d.valueOf();
              time += MS_PER_MINUTE - mod$2(time, MS_PER_MINUTE) - 1;
              break;
          case 'second':
              time = this._d.valueOf();
              time += MS_PER_SECOND - mod$2(time, MS_PER_SECOND) - 1;
              break;
      }
  ...
  function parsingFlags () {
      return extend$10({}, getParsingFlags(this));
  }
  ...
  //  commonjs-proxy-/Users/dtai/work/hanzo/getshopjs.com/node_modules/moment/src/moment.js
  ...
  //  commonjs-proxy-/Users/dtai/work/hanzo/getshopjs.com/node_modules/moment-timezone/moment-timezone.js

  //  commonjs-proxy-/Users/dtai/work/hanzo/getshopjs.com/node_modules/moment-timezone/data/packed/latest.json
  ...
  // node_modules/shop.js/src/index.coffee
  ...
  var initShop = function() {
    ...
    window.Shop = Shop$2;
    settings = {
      key: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzgyNDg5MTQsInN1YiI6IjBRVHhQSlo5RjMiLCJqdGkiOiJMeldxQjlTZU5wWSIsIm5hbWUiOiJ0ZXN0LXB1Ymxpc2hlZC1rZXkiLCJiaXQiOjQ1MDM2MTcwNzU2NzUxNzZ9.36emE_KqSzES7lLmJ8bJvUjznp7TFbzLzV8cMI2xCww',
      endpoint: 'https://api-dot-hanzo-production.appspot.com'
    };
    m = window.m = Shop$2.start(settings);
    window.client = Shop$2.client;
    return Shop$2;
  };
