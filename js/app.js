...
// ../el.js/src/views/inputify.coffee
var inputify;
var isRef;
...
Copy = (function(superClass) {
  ...
  Copy.prototype.copy = function(e) {
    var err, msg, range, s, successful, text, textArea;
    text = this.getText();
...
function from$1$1 (time, withoutSuffix) {
    if (this.isValid() &&
...
function isValid$3$1 () {
    return isValid$1$1(this);
}
...
var initShop = function() {
  ...
  window.Shop = Shop$2;
  settings = {
    key: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzgwNjc5MTEsInN1YiI6IjBRVHhQSlo5RjMiLCJqdGkiOiJQSm1JUkxhdWtkUSIsIm5hbWUiOiJ0ZXN0LXB1Ymxpc2hlZC1rZXkiLCJiaXQiOjQ1MDM2MTcwNzU2NzUxNzZ9.G7qQi6KgZE3RkSJ1gGBlImroZuqHKCTdanFb7dL4dWE',
...
var initPrism = function() {
  var clas, code, example, examples, html, lang, results;
  examples = {
    bootstrap: {
      javascript: 'import Shop from \'shop.js\';\nwindow.Shop = Shop;\nwindow.m = Shop.start({ key: \'<your key here>\' });'
    },
    example1: {
    ...
    example2: {
      html: '<checkout terms-url="/terms"></checkout>'
    },
    example3: {
  ...
  results = [];
  for (clas in examples) {
    example = examples[clas];
    results.push((function() {
      var results1;
      results1 = [];
      for (lang in example) {
        code = example[lang];
        html = Prism$1.highlight(code, Prism$1.languages[lang]);
